...
@Composable
fun AddToCatalogBottomSheet(
    supplement: com.example.meditox.database.entity.GlobalSupplementEntity,
    onDismiss: () -> Unit,
    onSuccess: () -> Unit = {},
    sheetState: SheetState,
    viewModel: AddToCatalogViewModel = viewModel(
    ...
    ModalBottomSheet(
        ...
        AddToCatalogContent(
            ...
            subtitle = "${supplement.supplementType} • ${supplement.brand}",
            formState = formState,
            uiState = uiState,
            onUpdateField = viewModel::updateFormField,
            onSubmit = { viewModel.addProductToCatalog(supplement.globalSupplementId, ProductCategory.SUPPLEMENT.toString()) }
        )
    }
}
...
@Composable
fun AddToCatalogBottomSheet(
    consumable: com.example.meditox.database.entity.GlobalSurgicalConsumableEntity,
    onDismiss: () -> Unit,
    onSuccess: () -> Unit = {},
    sheetState: SheetState,
    viewModel: AddToCatalogViewModel = viewModel(
    ...
    ModalBottomSheet(
        ...
        AddToCatalogContent(
            title = consumable.productName,
            subtitle = "${consumable.material} • ${consumable.brand}",
            formState = formState,
            uiState = uiState,
            onUpdateField = viewModel::updateFormField,
            onSubmit = { viewModel.addProductToCatalog(consumable.globalSurgicalId, ProductCategory.SURGICAL_CONSUMABLE.toString()) }
        )
    }
}
